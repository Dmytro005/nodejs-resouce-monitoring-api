...
helpers.getTemplate = function(templateName, data, callback) {
    ...
    readFileAsync(templatesDir + templateName + ".html", "utf-8")
        .then(str => {
            if (str && str.length > 0) {
        ...
        .catch(e => callback("No template could be found"));
};
...
// Take a given string and a data object and find and replace all the keys within it values
helpers.interpolate = function(str, data) {
    ...
    // For each key into data insert their value into the string at the corresponding placeholder
